...
export default class InfoDetail extends PureComponent {
  ...
  render() {
    ...
    const breadcrumbList = [{ title: '首页', href: '/' }, { title: '更多资讯', href: '/message/info-list' }, { title: '资讯详情' }];

    return (
      <PageHeaderLayout title="" breadcrumbList={breadcrumbList}>
        <div className={clsString}>
          <Card bordered={false} >
            <a className={styles.itunes_btn} onClick={() => this.props.dispatch(routerRedux.goBack())}>返回</a>
          </Card>
        </div>
