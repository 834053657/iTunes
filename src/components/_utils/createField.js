...
import { Form, Input, Radio, Select, Checkbox, Button, Switch} from 'antd';
...
const ASwitch = createField(Switch);

export { AInput, ARadioGroup, ASelect, AOption, ACheckbox, ATextarea, AInputNumber, AUpload, ASwitch };
